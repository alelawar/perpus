<x-html>
    ...
    <div x-data="{ open: false }" class="relative">
        ...
        <aside class="fixed top-0 left-0 w-[240px] h-screen bg-tersier-color shadow-lg flex flex-col p-4 transform transition-transform duration-300 ease-in-out z-50"
            ...
            <div class="text-left mt-12">
                <h1 class="text-xl font-bold text-black">PERPUS<br><span class="text-primer-color">SMK Infokom</span></h1>
            </div>
            ...
            <div class="flex flex-col justify-between h-screen mt-5">
                ...
                <button class="bg-skunder-color text-white font-bold py-2 w-1/2 rounded-full shadow-xl cursor-pointer mx-auto mb-10 hover:bg-transparent hover:text-skunder-color hover:ring-2 transition duration-500">
                    Login
                </button>
            </div>
        ...
        <aside class="hidden md:block">
            <div class="sidebar top-0 bottom-0 lg:left-0 left-[-300px] p-2 w-[240px] overflow-y-auto text-center bg-tersier-color h-screen shadow-[4px_0_10px_rgba(0,0,0,0.3)] flex flex-col justify-between ">
                <div class="text-xl">
                    <div class="p-2.5 mt-11 mb-11 items-center justify-center flex rounded-md text-left">
                        <h1 class="text-[15px] text-xl text-black font-bold">PERPUS<br><span class="text-primer-color">SMK Infokom</span></h1>
                    </div>

                    <div class="text-black -mt-10">
                        <div class="p-2.5 mt-2 flex items-center rounded-md px-4 duration-300 cursor-pointer hover:text-skunder-color ">
                        ...
                        <div class="p-2.5 mt-2 flex items-center rounded-md px-4 duration-300 cursor-pointer hover:text-skunder-color ">
                            ...
                            <a href="wishlist" class="text-[15px] ml-2">Wishlist</a>
                        </div>
                        <div class="p-2.5 mt-2 flex items-center rounded-md px-4 duration-300 cursor-pointer hover:text-skunder-color ">
                            <span>
