            ...
            <div class="w-1/2 h-full px-8 flex justify-center flex-col bg-white rounded-xl">
                ...
                <form action="/auth/login" method="POST" class="space-y-4 mt-5">
                    ...
                    <div class="relative bg-tersier-color rounded-lg">
                        ...
                        <input name="password"
                            class="w-full py-2 pl-10 pr-4 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-skunder-color bg-transparent"
                    ...
                    <button
                        class="w-1/3 py-2 block mx-auto bg-skunder-color text-white text-xs font-bold rounded-lg hover:bg-transparent hover:text-skunder-color hover:border-blue-300 border-2 focus:ring focus:ring-blue-300 transition duration-500"
                        type="submit">
                        Masuk
                    </button>
                </form>
