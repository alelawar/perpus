                                        ...
                                        <tr class="border-b border-gray-200 hover:bg-gray-100">
                                            ...
                                            <td class="py-3 px-6 text-left">
                                                <select name="status[{{ $p->id }}]" class="bg-gray-50 rounded p-1"
                                                    x-bind:disabled="actionType === 'delete'">
                                                    <option value="belum dikembalikan" {{ $p->status == 'belum dikembalikan' ? 'selected' : '' }}>Belum Dikembalikan</option>
                                                    <option value="telah diambil" {{ $p->status == 'telah diambil' ? 'selected' : '' }}>Telah Diambil</option>
                                                    <option value="sudah dikembalikan" {{ $p->status == 'sudah dikembalikan' ? 'selected' : '' }}>Sudah Dikembalikan</option>
                                                </select>
                                            </td>
                                        </tr>
                                    @empty
